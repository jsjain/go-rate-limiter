...
//
// These compute in floating-point seconds and subtract two values of epoch
// magnitude, which costs enough precision to under-report Remaining by one for
// some limits: PerSecond(10) reports 9 available tokens as 8. Kept deliberately;
// an exact integer-microsecond version cost ~12% throughput. See the README.
